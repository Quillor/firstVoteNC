		...
		<div style="width:100%;">
			...
			<table class="form-table">
				...
				<tr class="form-field">
					...
					<td>
						<p><?php _e( 'Do you wish to send a mail with credentials and other data?', 'import-users-from-csv-with-meta' ); ?> <input type="checkbox" name="sends_email" value = "<?php _e('yes','import-users-from-csv-with-meta'); ?>" checked="checked"></p>

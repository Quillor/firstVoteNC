...
add_shortcode( 'unity-login-form', function($attributes, $content = null) {
  ...
  if ( is_user_logged_in() ) {
    ...
    if ( $attributes['password_updated'] ) {
      $return .= '<div class="alert alert-info" role="alert">Your password has been changed. For enhanced security please sign in now.</div>';
    }
        ...
        if ( isset( $_REQUEST['login'] ) && isset( $_REQUEST['key'] ) ) {
            ...
            ob_start();
              ...
              <form name="resetpassform" id="resetpassform" action="<?php echo $loginurl; ?>" method="post" autocomplete="off">
                ...
                <div class="form-group">
				<p>Create your own password to make your account more secure.</p>

				<p>Hint: To make your password secure, it should be at least six characters long. To make it stronger, use upper and lower case letters, numbers, and symbols like ! " ? $ % ^ &amp; ).</p>
                ...
                <div class="form-group resetpass-submit">
                  <input type="submit" name="submit" id="resetpass-button" class="btn btn-default" value="<?php _e( 'COMPLETE REGISTRATION', 'unity-login' ); ?>" />
                </p>
              </form>
              <?php
            $form = ob_get_clean();
